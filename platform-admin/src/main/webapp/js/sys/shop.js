$(function () {
    $("#jqGrid").Grid({
        ...
        colModel: [
            ...
            {label: '订单数', name: 'orderCount', width: 100},
            {label: '交易金额', name: 'transactionAmount', width: 100},
            {
            ...
            {
                label: '到期时间', name: 'expireTime', index: "expire_time", width: 80, formatter: function (value) {
                    return transDate(value);
                }
            }]
    });
