...
import com.platform.utils.HeaderParamsUtils;
...
//        dataSource.getJdbcUrl();
        ...
        if(sql.indexOf("where") != -1 || sql.indexOf("WHERE") != -1){
            ...
            String whereSplit[] = sql.split("where");
            sql = whereSplit[0] + " WHERE seller_id = " + HeaderParamsUtils.getSellerId() + " AND " + whereSplit[1];
        }
