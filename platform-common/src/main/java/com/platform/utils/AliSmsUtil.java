...
public class AliSmsUtil {
    ...
    static final String accessKeyId = "LTAI6MAMKi4HX1Yc";
    static final String accessKeySecret = "lxt4L6pE2lSWUk2F0wSGu1icNz3v9U";
    ...
    public static SendSmsResponse sendSms() throws ClientException {
        ...
        //必填:待发送手机号
        request.setPhoneNumbers("15507586703");
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("西卡网");
        //必填:短信模板-可在短信控制台中找到
    ...
    public static QuerySendDetailsResponse querySendDetails(String bizId) throws ClientException {
        ...
        //必填-号码
        request.setPhoneNumber("15507586703");
        //可选-流水号
